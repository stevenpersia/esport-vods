...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { link: @support.link, name: @support.name, subtitle: @support.subtitle } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { link: @support.link, name: @support.name, subtitle: @support.subtitle } }
